...
export function getInstrumentoJSON()
{    
    ...
    },
    {
        ...
        costoEnvio: "250",
        cantidadVendida: "380",
        descripcion: " DE 1 A 3 AÑOS. EL SET INCLUYE 5 TAMBORES, PALILLOS Y EL PLATILLO TAL CUAL LAS FOTOS. SONIDOS REALISTAS Y FÁCIL DE MONTAR. MEDIDAS: 40X20X46 CM"
    }
];
return datos;
...
export async function getInstrumentosXIdFecth(id:number){
